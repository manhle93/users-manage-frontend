<template>
  <v-card class="mx-auto">
    <v-toolbar color="#00695C" dark>
      ...
      <v-toolbar-title>Danh mục loại hình trực</v-toolbar-title>
    ...
    <v-list subheader two-line v-else>
      <v-subheader inset>Danh sách loại hình trực</v-subheader>
      <v-list-item v-for="nhom in nhomTos" :key="nhom.title">
        <v-list-item-avatar>
          <v-icon class="grey lighten-1" dark> mdi-calendar-clock</v-icon>
        </v-list-item-avatar>
...
import { getLoaiTruc } from "@/api/lichtruc";
